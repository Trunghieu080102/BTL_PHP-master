         ...
         ?>
               <div class="box">
                  ...
                  <form action="" method="post">
                     ...
                     ?>
                     <a href="admin_orders.php?cancel=<?= $fetch_orders['id'] ?>& status=<?= $fetch_orders['status'] ?>& products=<?= $fetch_orders['total_products'] ?>" onclick="return confirm('Hủy đơn hàng này?');" class="delete-btn">Hủy</a>
                     <a href="admin_orders.php?delete=<?= $fetch_orders['id'] ?>& status=<?= $fetch_orders['status'] ?>" onclick="return confirm('Xóa đơn hàng này?');" class="delete-btn">Xóa</a>
                  </form>
               </div>
         <?php
            }
